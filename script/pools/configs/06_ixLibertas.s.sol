 ...
 * @notice Seven-asset Non-Standard pool — scrvUSD 15% + ysyBOLD 14% + USDC 14% + sUSDS 14% + PYUSD 15% + Aave Prime GHO 14% + USDT 14%.
 ...
 *      scrvUSD 15% / ysyBOLD 14% / USDC 14% / sUSDS 14% / PYUSD 15% / Aave Prime GHO 14% / USDT 14%.
 ...
 *      `YSYBOLD_RATE_PROVIDER` env var. sUSDS and Aave Prime GHO use the verified mainnet RP literals below; USDC, USDT, and
 ...
 *      sUSDS 14 + Aave Prime GHO 14 — sum to a 57% numerator (0.57e18); USDC, PYUSD, and USDT bind as bare
 ...
 *      Aave Prime GHO (`0xC71E…`), USDT (`0xdAC1…`). No runtime sort.
 */
library IxLibertasConfig {
    ...
    function config(address scrvUsdRp, address ysyBoldRp) internal pure returns (PoolConfig memory) {
        ...
        tokenTypes[5] = TokenType.WITH_RATE;    // Aave Prime GHO
        ...
        rateProviders[5] = IRateProvider(AAVE_PRIME_GHO_RATE_PROVIDER);
        ...
        paysYieldFees[5] = true;    // Aave Prime GHO (WITH_RATE + RP)
        ...
        normalizedWeights[5] = 0.14e18;  // Aave Prime GHO 14%
