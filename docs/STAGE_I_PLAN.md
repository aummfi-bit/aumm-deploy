...
> **Status:** I-reframe doc sweep COMPLETE — per OQ-25 / I-D14, AuMT is the pool's own Balancer V3 BPT, not a separate token; Stage I is now the oracle-free **recorder clock + hook dispatch** only. Decisions I-D1—I-D17 LOCKED: I-D14 (AuMT = BPT), I-D15 (value-weighted view deferred to a Stage K `VotingWeight.sol`), I-D16 (hook one-shot `emissionRecorder` slot), I-D17 (`IVotingWeight` forward stub + `VaultClassRegistry` full-rename fix-forward); I-D1—I-D4 / I-D11 / I-D12 SUPERSEDED + I-D5—I-D9 AMENDED by I-D14. I3 (concrete `AuMT.sol`) TOMBSTONED — superseded, removed at I9. I4 reframed to recorder dispatch + clock; I9 new family (AuMT deprecation + IVotingWeight migration). I1 (I-D9), I2 (I-D10), I8 (I-D13) unchanged. Findings I10—I14. Code phase (I9 → I4 → I5/I6 → I7) next. Companion to STAGE_I_NOTES.md.
>
> **Last update:** 2026-06-04 — I-reframe doc sweep COMPLETE (status/header refresh this commit; Completion Log + Anchors + CLAUDE §11 follow). This session: I-D17 LOCK (`118b8e7`) + I-D15 amend (`4a4b1d8`) + I14 Findings (`f894c82`); PLAN Decisions I-D17 (`5a4c66c`); Stage scope (`25f0cb8`) + Surfaces (`09bfc34`); I9 roadmap (`d16365d`); I3 tombstone (`0bf7eef`); Surfaces I9 rows (`1990479`); I4 (`c327d22`) / I5 (`c8c24be`) / I6 (`d338109`) / I7 (`a1a1bbd`) reframe; Interfaces Produced (`784f6b0`) + Consumed (`1e638bd`). Prior session landed I-D14 / I-D15 / I-D16 + Decisions flips. Code phase (I9.1 `IVotingWeight.sol`) next.
>
> **Mode:** Opus high per §13 stage-level defaults. I-reframe doc sweep COMPLETE. Code phase next: I9 (AuMT deprecation + IVotingWeight migration) → I4 (recorder dispatch + clock) → I5/I6 (recorder-clock unit + fork tests) → I7 (deploy + close-of-stage). Entry mode Opus high (live design on the IVotingWeight surface, hook callbacks, EmissionDistributor clock math).
>
