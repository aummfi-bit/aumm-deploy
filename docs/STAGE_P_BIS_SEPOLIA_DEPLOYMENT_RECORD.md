...
**What remains.** Runbook phase 5, the F-09 Router seat, is two governor-signed transactions still outstanding and structurally absent from the orchestrator per P-D26 (4). Phase 6 explorer verification stays blocked on the absent `ETHERSCAN_API_KEY`. der Bodensee is registered and unseeded, deferred to PB3.9 behind genesis at block 11477620 per PB-D41. And the two findings above are open — PB-D50 carrying a `_venueRatio` fix plus an H-D9 amendment, PB-D51 standing as a Stage-R gate.
