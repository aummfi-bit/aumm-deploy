...
Mirror of STAGE_K_NOTES.md Decisions table (K-D1 + K-D2 LOCKED at K0.2; K-D3 LOCKED at K1 pre-flight; K-D4 LOCKED at K2 pre-flight; K-D5 LOCKED at K3 pre-flight; K-D6—K-D9 forward-declared, each locking at its unit pre-flight).
