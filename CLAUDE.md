...
Earlier Stage H commits (H0—H5.5a reshape chain) live in `git log stage-h ^stage-g-complete` between branch point `384a40b` and `71a6d29` HEAD (153 commits total at H6.4b). Full Completion Log in `docs/STAGE_H_PLAN.md`.
